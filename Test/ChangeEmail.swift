            ...
            ZStack {
                VStack (alignment: .center) {
                    ...
                    VStack {
                        ...
                        TextField("Current Email Address", text: $email)
                            .autocapitalization(.none)
                            .disableAutocorrection(true)
                            .padding()
                            .foregroundColor(Color("whiteblack").opacity(0.65))
                            .background(LinearGradient(gradient: Gradient(colors: [Color(.secondarySystemBackground).opacity(0.18), Color(.secondarySystemBackground).opacity(0.36)]), startPoint: .leading, endPoint: .trailing))
